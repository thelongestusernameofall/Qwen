...
MODEL="/mnt/data/models/qwen/Qwen/Qwen-7B-Chat/"
DATA="/mnt/data/datasets/simon/sft/wanshitong/all-1227-sample.json"
output_path="/mnt/data/models/qwen/Qwen/Qwen-7B-Chat-act1227-v1"
